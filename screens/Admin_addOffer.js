...
import Bo from '@gorhom/bottom-sheet';
...
const Admin_addOffer=()=>
{
   ...
   // console.log(colorsArray[2])
    ...
    return(
        ...
        colors={[dummydata.background_color,dummydata.background_color_2]}
        >      
        <View
        style={
            {
        ...
        >
            ...
            >Get exciting deal on</Text>
            <Text
            style={
                {
                   
                    color:dummydata.font_brand_color,
                    fontFamily:fonts.Federo_Regular,
                    
                    fontSize:20
                }
            }
            >{dummydata.pbrand} 'S {dummydata.pname}</Text>
           {(dummydata.focus=='discount') ? <Text
             style={
                {
                    marginVertical:10,
                    color:"#fff",
            ...
            >
                RS {dummydata.pprice-(dummydata.pdisc*dummydata.pprice/100)}
            </Text>
            <Text
             style={
                {
